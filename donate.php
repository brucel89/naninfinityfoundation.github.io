...
<head>
  <meta charset="UTF-8">
    ...
    <title>Donate | Naninfinity Foundation</title>
...
<section class="content-height" >
    ...
    <p>Thank you very much for your interest in supporting us financially by donating to our Nan Infinity Foundation.  You can donate there through credit card, Paypal and a variety of other options. You can also set up monthly donation options if you would like.
    <br>
    We believe that transparency is extremely important and want to be clear that there are absolutely zero administration fees deducted by us from donations independent of banking/platform charges.    
    </p>
    </div>    
    </div>
  </div>
...
<div class="parallax">
  ...
  <div class="Donate_button">
      <a href="https://frch.in/ykEuoR830kb" target="_blank" class="donate_icon">
        <i class="">Donate</i>
      </a>
  </div>
</div>
